...
The database schema is highly flexible and generalizable, allowing researchers to manage data from diverse sensor types and ecological projects while facilitating data sharing and integration when appropriate. At the core of WildTrax’s design are environmental sensors and their associated metadata. The system supports multiple sensor types and configurations, efficiently linking sensor data to sensor deployment details. This structure allows seamless tracking of data through multiple stages of collection and processing. Data entities are managed both as inputs and outputs throughout the workflow, enabling users to access data at various processing stages. WildTrax centers its database architecture around sensor deployments and their recordings, including key metadata such as deployment location (site name, coordinates, elevation), study area information (project name, organization, time zone), and sensor configurations. This architecture supports the comprehensive capture of acoustic, camera, and environmental sensor data within one unified system.
...
Alexander G. MacPhail conceived and designed the manuscript, coordinated acoustic data collection and processing using WildTrax, performed data analysis, and drafted the manuscript. He played a key principal role in the acoustic sensor design and development.

Erin M. Bayne contributed to study design as the lead scientific developer, provided overall scientific guidance, and assisted with manuscript revision.

Corrina Copp supported platform development and data management, with a particular focus on camera sensor design and development, and contributed to manuscript editing.

Michael Packer served as lead developer, overseeing server architecture, back-end development, system scalability, and ensuring robust data processing workflows.

Chad Klassen designed the user interface, provided front-end development, and led user experience design to optimize accessibility and usability across devices.
